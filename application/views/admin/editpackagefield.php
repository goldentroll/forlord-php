...
<div class="section row mb10">
                    ...
                    <div class="col-sm-7 ph10">
                    <label for="directcommission" class="field prepend-icon">
                    <input type="text" name="indirectcommission" id="indirectcommission" placeholder="<?php echo  ucwords($this->lang->line('indirectcommission')); ?>"
                    class="gui-input" value="<?php echo set_value('indirectcommission', isset($this->data['fielddata']->LevelCommissions) ? $this->data['fielddata']->LevelCommissions : '');?>" >
                    ...
                    <div class="section row mb10">
                        <label for="directcommission" class="field-label col-sm-3 ph10  text-left">Mining Reward<sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
        ...
        $commissions = $this->data['fielddata']->mining_reward_upline;
        ...
        <?php
        $counts1 = count($explode)+1;
        ?>
        <input type="hidden" id="lvlprtcount2" name="lvlprtcount2" value="<?php echo $counts2;?>">
        ...
        $commissions = $this->data['fielddata']->ProductLevelCommissions;
    ...
    <input type="hidden" id="lvlprtcount" name="lvlprtcount" value="<?php echo $counts;?>">
        ...
        <div class="section row mb10">
        <label for="indirectcommission" class="field-label col-sm-3 ph10  text-left">Coin -Rewards <sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
        <div class="col-sm-7 ph10">
        <label for="directcommission" class="field prepend-icon">
        <input type="text" name="token_reward" id="token_reward" placeholder="Coin-Reward"
        ...
        <?php echo form_error('token_reward');?>
         ...
         <div id="commission">
                <div class="section row mb10" id="levelcommissiondivp">
                <label for="levelcommission" class="field-label col-sm-4 ph10  text-left">Coin-Reward Upline<sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
                <div class="col-sm-3 ph10">
                ...
                $commissions = $this->data['fielddata']->token_reward_upline;
                ...
                <label for="levelcommission" class="field-label col-sm-3 ph10 md10"></label>
                <div class="col-sm-7 ph10 md10 " >
                <input type="text" name="levelcommission1[]" id="levelcommission1[]" placeholder="<?php echo  "Coin Reward Upline";echo" 1 ".  ucwords($this->lang->line('comamount')); ?>"
                class="gui-input" value="<?php echo $explode[$i];?>" >
                ...
                $counts1 = count($explode)+1;
                ?>
<input type="hidden" id="lvlprtcount1" name="lvlprtcount1" value="<?php echo $counts1;?>">
...
<script src="<?php echo base_url();?>assets/js/plugins/ckeditor/ckeditor.js"></script>
  <script type="text/javascript">
                        ...
                        levelcommissiondiv1.after().html('<label class="col-sm-3 ph10 "></label><div class="col-sm-7 ph10 mb10"><input type="text" name="levelcommission1[]" placeholder="Coin Reward upline'+ counter+' Commission Amount" id="levelcommission1'+ counter+'" value="" class="gui-input" ></div>');
