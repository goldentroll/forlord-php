        ...
        $membercount = $this->data['fielddata']->Membercount;
        $referalcount = $this->data['fielddata']->ReferalCount;
        $balanceamount =  $this->data['fielddata']->balanceAmount;
        $target_point =  $this->data['fielddata']->target_point;
        $rank = $this->data['fielddata']->rank;
        $status =  $this->data['fielddata']->status;
        $targetcount = $this->data['fielddata']->target_rank;

        ?>
        <select name="targetcon" id="targetcon" onchange="getcon(this.value);" > 
        <option value="">Select Condition</option>
        <option value="1" <?php if($targetcount=="1"){ echo "selected"; }?>><?php echo "Target Downline Count";?></option>
        <option value="2" <?php if($targetcount=="2"){ echo "selected"; }?>><?php echo "Target ReferalMember Count";?></option>
        <option value="3" <?php if($targetcount=="3"){ echo "selected"; }?>><?php echo "Target balance Amount";?></option>
        <?php
        ...
        <option value="4" <?php if($targetcount=="4"){ echo "selected"; }?>><?php echo "Target Pv & Gv count";?></option>

        <?}
        if($id=="4")
        {?>

        <option value="5" <?php if($targetcount=="5"){ echo "selected"; }?>><?php echo "Target total Left and right down count";?></option>
        <option value="6" <?php if($targetcount=="6"){ echo "selected"; }?>><?php echo "Target total Left and right Package Fees";?></option>
    ...
    <label for="Rank" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('rank')); ?> <samll class="text-danger">*</samll></label>
    ...
    <label for="min_pack_inves" class="field-label col-sm-3 ph10  text-left">Min package investment <samll class="text-danger">*</samll></label>
    ...
    ?>
    <option value="<?php echo $key->rank_id; ?>" <?php if($key->rank_id== $this->data['fielddata']->current_lev){ echo "selected"; }?>><?php echo $key->Rank; ?></option>
    <?
    }
    }
    ?>
     ...
     <div class="section row mb10" id="min_pack_inves">
    <label for="min_pack_inves" class="field-label col-sm-3 ph10  text-left">Eligible for earnings <samll class="text-danger">*</samll></label>
  ...
  <div class="section row mb10" id="min_pack_inves">
    <label for="min_pack_inves" class="field-label col-sm-3 ph10  text-left">Rank Reward as Coin <samll class="text-danger">*</samll></label>

    <div class="col-sm-7 ph10">
    <label for="elig_earn" class="field prepend-icon">
    <input type="text" name="rank_reward" id="rank_reward" placeholder="Rank_Reward"
    ...
    <option value="1" <?php if($this->data['fielddata']->bonus_type=='1'){echo "selected";} ?>>Cash</option>
    <option value="2" <?php if($this->data['fielddata']->bonus_type=='2'){echo "selected";} ?>>Non Cash</option>
    </select>
...
<?php echo set_value('non_cash', isset($this->data['fielddata']->non_cash) ? $this->data['fielddata']->non_cash : '');?>
    </textarea>
    <?php echo form_error('non_cash');?>
     ...
     <div class="section row mb10" id="min_pack_inves">
    <label for="min_pack_inves" class="field-label col-sm-3 ph10  text-left">Bonus amount <samll class="text-danger">*</samll></label>
    ...
    <?php echo form_error('bonus_amt');?>
        ...
        class="gui-input" value="<?php echo set_value('rewardpoint', isset($this->data['fielddata']->ReferalCount) ? $this->data['fielddata']->ReferalCount : '');?>" >
        ...
        class="gui-input" value="<?php echo set_value('rewardpoint', isset($this->data['fielddata']->balanceAmount) ? $this->data['fielddata']->balanceAmount : '');?>" >
        <label for="rewardpoint" class="field-icon">
        ...
        $commissions = $this->data['fielddata']->level_commissions;

        $explode = explode(',',$commissions);
        ...
        <div class="section row mb10" id="levelcommissiondivp<?php echo $lvl;?>">
        ...
        <input type="text" name="levelcommission[]" id="levelcommission<?php echo $lvl;?>" placeholder="<?php echo  ucwords($this->lang->line('level'));echo $lvl.' '.  ucwords($this->lang->line('comamount')); ?>"
        class="gui-input" value="<?php echo $explode[$i];?>" >
        ...
        <?php
        $counts = count($explode)+1;

        ?>
        <input type="hidden" id="lvlprtcount" name="lvlprtcount" value="<?php echo $counts;?>">
    ...
    <!--     <div class="section row mb10" style="display: none" id="rankcount">
        ...
        <input type="radio" <?php if($this->data['fielddata']->Status==1){echo "checked='checked'";}else{echo "";}?> value='1' name="status">
        <span class="radio"></span>
        <?php echo  ucwords($this->lang->line('on'))?>
        </label>

        <label class="col-md-3 block mt15 option option-primary">
        <input type="radio" <?php if($this->data['fielddata']->Status==0){echo "checked='checked'";}else{echo "";}?> value='0' name="status">
        <span class="radio"></span>
