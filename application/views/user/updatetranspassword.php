...
<div id="content">
    ...
    <h3 class="fw-normal2 text-white">Change Transaction Password </h3>
    </div>
	...
	<h2 class="text-white fw-bold mb-3 text-uppercase">Change Transaction Password</h2>
	</div>
	</div>
	</div>
	...
	">New Password <small class="text-danger"> *</small></label>
	...
	<div class="mb-3 form-block position-relative">
	<label for="text-white mb-3" style="color: white;margin-bottom: 10px;
	"><?php echo  ucwords($this->lang->line('loginpassword')); ?><small class="text-danger"> *</small></label>
	<div class="form-ico bg-gradient rounded-circle box"> <i class="fa fa-unlock-alt text-white"></i>
	</div>
