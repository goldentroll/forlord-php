...
Class Facebook
{
    ...
    public function __construct(){
        ...
        if (!isset($this->fb)){
            ...
            $subsett=$this->db->query("select * from arm_setting where KeyValue='fb_client_id'")->row();
            $subsets=$this->db->query("select * from arm_setting where KeyValue='fb_client_secret'")->row();
        

            $this->fb = new FB([
                'app_id'                => $subsett->ContentValue,
                'app_secret'            => $subsets->ContentValue,
