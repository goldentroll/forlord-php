...
<?php echo form_error('reward_time');?>
 ...
 <div class="section mb10">
<p><?php echo $this->lang->line('label_nav_title');?>Coin Reward  <sup class="state-error1">*</sup></p>
<label class="field prepend-icon" for="reward_time">

 <input type="text" id='video_reward' name="video_reward" class="form-control" placeholder="" value="<?php echo set_value('video_reward',isset($page_data[0]->video_reward) ? $page_data[0]->video_reward : ''); ?>" step='1' min="00:00:00" >

<label class="field-icon" for="reward_time">
<i class="ad ad-lines"></i>
</label>
</label>
<?php echo form_error('video_reward');?>
</div>
  ...
  $('.cms').formValidation({
                ...
                fields: {
                    ...
                    video_reward: {
                        validators: {
                            notEmpty: {
                                message: 'video Reward is required and can\'t be empty'
                            },
                        }
                    },
                     reward_time: {
