...
<?php echo form_error('earning_mode'); ?>
        ...
        <?php echo form_error('target_bonus');?>
         ...
         <div class="section row mb10">
        <label for="target_rewards" class="field-label col-sm-3 ph10  text-left"><?php echo  " Coin Rewards"; ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

        <div class="col-sm-7 ph10">
        <label for="target_rewards" class="field prepend-icon">
        <input type="text" name="target_rewards" id="target_rewards" placeholder="<?php echo  "Coin-Rewared"; ?>"
